...
const firstnames = runners.map( function(currentValue){ 
...
for(let i = 0; i < runners.length; i++){
  function doSomething(){    
    ticketPriceTotal.pop();
    totalDonations += runners[i].donation
...
// Problem 1  The race is being postponed due to rain the director needs all the runners emails.
...
// Problem 2  we have found all the large chirts give a list of the large shirt size runners.
...
// Problem 3 The director needs all the company names to be able to promote them in the race.
